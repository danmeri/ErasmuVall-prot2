        ...
        <div class="wrapper" align="center">
            ...
            <div class="centroSinLinea">
                ...
                <form id="registro" action="Controlador" method="post">
                    Facultad:
                    <%FacultadDAO facul=new FacultadDAO();
                    ArrayList<FacultadDTO> facultades=facul.getTodas();%>
                    <select name="facultad">
                        <%for (int i=0;i<facultades.size();i++){
                            FacultadDTO f=facultades.get(i);%>
                            <option selected value="<%=f.getId()%>"><%=f.getNombre()%>
                        <%}%>
                    </select> <br><br>
                    Nacionalidad:
