...
<html>
    ...
    <%@page pageEncoding="UTF-8"%> 
        <title>ErasmuVall-Alojamiento</title>
            ...
            <div class="centroCarrusel2">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="imagenes/alojamiento/residencias.jpg" alt="Residencia Universitaria">
                        <div class="carousel-caption">
                            <h3>Residencias Universitarias</h3>
                        </div>
                    </div>

                    <div class="item">
                        <img src="imagenes/alojamiento/pisos.jpg" alt="Pisos">
                        <div class="carousel-caption">
                            <h3>Pisos</h3>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <img src="imagenes/alojamiento/habitacion.jpg" alt="Habitaciones">
                        <div class="carousel-caption">
                            <h3>Habitaciones</h3>
                        </div>
                    </div>
