            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="imagenes/inicio/caballeria.jpg" alt="CaballerÃ­a">
                    </div>

                    <div class="item">
                        <img src="imagenes/inicio/rio.jpg" alt="RÃ­o">
                        <div class="carousel-caption">
                        </div>
                    </div>

                    <div class="item">
                        <img src="imagenes/inicio/derecho.jpg" alt="Derecho">
                    </div>

                    <div class="item">
                        <img src="imagenes/inicio/hotel.jpg" alt="Hotel">
                    </div>
                </div>
