        ...
        <div class="wrapper" align="center">
            ...
            <div class="centro" style="text-align:left">
                ...
                <form id="formViaje">
                    ...
                    Nombre del viaje: <input type="text" id="Lugar" ><br>
                    Lugar: <input type="text" id="Lugar" ><br>
                    Hora de salida: <input type="text" class="textoPeq"><br>  
                    Dirección de salida: <input type="text" id="Lugar" ><br>
                    Incluir mapa: <input type="checkbox" id="inclMapa"><br>
                    Fecha del viaje: <input type="text" class="textoPeq"><br>
                    Precio del viaje: <input type="text" class="textoPeq"><br>           
                    Mas Datos:<br>
